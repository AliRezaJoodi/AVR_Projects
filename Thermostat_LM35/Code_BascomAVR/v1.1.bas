...
Dim Fan_status As Bit
Dim Heater_status As Bit
...
Show_temp:
   ...
   Locate 2 , 1 : Lcd "Fan:" ; Fan_status
   Locate 2 , 11 : Lcd "Heat:" ; Heater_status
Return
...
Setting_hiter:
   ...
   If Temp < Minimum_temperature_low Then
      Set Heaters : Heater_status = 1
   Elseif Temp > Minimum_temperature_high Then
      Reset Heaters : Heater_status = 0
   End If
Return
