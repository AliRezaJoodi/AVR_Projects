...
Config Portb.1 = Output : Portb.1 = 0 : Led_green Alias Portb.1
Config Portb.0 = Output : Portb.0 = 0 : Led_red Alias Portb.0

'Config Debounce = 30
Config Portd.2 = Input : Portd.2 = 1 : Key_register Alias Pind.2
Config Portd.4 = Input : Portd.4 = 1 : Key_unregister Alias Pind.4
Config Portd.5 = Input : Portd.5 = 1 : Key_unregister_all Alias Pind.5
...
Do
   ...
   If Key_unregister_all = 0 And Status_key_unregister_all = 0 Then
      ...
      If Key_unregister_all = 0 And Status_key_unregister_all = 0 Then
         ...
         Gosub Eeprom_load
         Cls : Locate 1 , 1 : Lcd "Memory is Erased" : Wait 1 : Cls
      End If
   End If
