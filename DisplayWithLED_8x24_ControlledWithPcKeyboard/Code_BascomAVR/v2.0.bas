...
Config Portd.6 = Output : Portd.6 = 0 : Data_4 Alias Portd.6
Config Portd.5 = Output : Portd.5 = 0 : Data_5 Alias Portd.5
Config Portd.4 = Output : Portd.4 = 0 : Data_6 Alias Portd.4
...
Config Portc.4 = Output : Portc.4 = 0 : Matrix_1 Alias Portc.4
Config Portc.5 = Output : Portc.5 = 0 : Matrix_2 Alias Portc.5
Config Portc.6 = Output : Portc.6 = 0 : Matrix_3 Alias Portc.6
...
Get_pc_kepad:
Gosub Led_1
Config Keyboard = Pind.3 , Data = Pinc.7 , Keydata = Keydata
Do
   Key = Getatkbd()
   If Key <> 0 Then
   If Key = 25 Then
...
'**********************************************
Led_1:
   Reset Matrix_1 : Set Matrix_2 : Reset Matrix_3
   Reset Column_h : Reset Column_g : Reset Column_f : Reset Column_e : Reset Column_d : Reset Column_c : Reset Column_b : Reset Column_a
   Reset Data_0 : Reset Data_1 : Reset Data_2 : Reset Data_3 : Reset Data_4 : Reset Data_5 : Reset Data_6 : Reset Data_7

   Reset Matrix_1 : Reset Matrix_2 : Set Matrix_3
   Reset Column_h : Reset Column_g : Reset Column_f : Reset Column_e : Reset Column_d : Reset Column_c : Reset Column_b : Reset Column_a
   Reset Data_0 : Reset Data_1 : Reset Data_2 : Reset Data_3 : Reset Data_4 : Reset Data_5 : Reset Data_6 : Reset Data_7

   Set Matrix_1 : Reset Matrix_2 : Reset Matrix_3
