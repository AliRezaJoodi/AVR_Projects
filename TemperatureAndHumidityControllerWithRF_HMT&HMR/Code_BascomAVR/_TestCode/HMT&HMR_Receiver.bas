...
Config Portc.4 = Output : Portc.4 = 0 : Relay_1 Alias Portc.4
Config Portc.5 = Output : Portc.5 = 0 : Relay_2 Alias Portc.5
Config Portc.2 = Output : Portc.2 = 0 : Relay_3 Alias Portc.2
Config Portc.1 = Output : Portc.1 = 0 : Relay_4 Alias Portc.1
      ...
      Case 13:
         ...
         If Address = "123" Then
            Set Led
               ...
               Relay_status = Relay_status Xor &B00001111
