...
#define Column_b  PORTC.4
#define Column_c  PORTC.4
#define Column_d  PORTC.4
#define Column_e  PORTC.4
#define Column_f  PORTC.4
#define Column_g  PORTC.4
#define Column_h  PORTC.4
            ...
            for(Refresh=1;Refresh<=Spead;Refresh++)
            {
                ...
                for(i=s;i<=e;i++)
                {
                    for(b=0;b<=3;b++)
                    {
                        ...
                        if ((dd&&0b00000001)>0){Data_7=1;} else { Data_7=0;}; 
                        if ((dd&&0b00000010)>0){Data_6=1;} else { Data_6=0;}; 
                        ...
                        Segment=2^b;
                        if ((dd&&0b00000001)>0){Matrix_1=1;} else { Matrix_1=0;};
                        if ((dd&&0b00000010)>0){Matrix_2=1;} else { Matrix_2=0;}; 
                        if ((dd&&0b00000100)>0){Matrix_3=1;} else { Matrix_3=0;};
                        delay_us(10);Matrix_1=0;Matrix_2=0;Matrix_3=0;  
                    }
