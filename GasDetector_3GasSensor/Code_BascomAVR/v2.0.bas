...
Dim Setting_min_mq4 As Single
Dim Setting_min_mq4_eeprom As Eram Single
Dim Setting_min_mq135 As Single
Dim Setting_min_mq135_eeprom As Eram Single
Dim Setting_min_mq9 As Single
Dim Setting_min_mq9_eeprom As Eram Single
Dim Z1 As Single
Dim Z2 As Single
Dim S1 As Single
Dim Input_percent_MQ4 As Integer
Dim Input_percent_mq135 As Integer
Dim Input_percent_mq9 As Integer

If Key_set = 0 Then
   Gosub Read_mq4 : Setting_min_mq4_eeprom = Input_voltage
   Gosub Read_mq135 : Setting_min_mq135_eeprom = Input_voltage
   Gosub Read_mq9 : Setting_min_mq9_eeprom = Input_voltage
   Gosub Sound_menu
End If
...
Read_MQ4:
   ...
   Z1 = Input_voltage -setting_min_mq4 : Z1 = Z1 * 100
   Z2 = 5 - Setting_min_mq4
   Input_percent_mq4 = Z1 / Z2
Return
...
Read_mq135:
   ...
   Input_voltage = W / 0.2048
   Input_voltage = Input_voltage / 1000
   Z1 = Input_voltage -setting_min_mq135 : Z1 = Z1 * 100
   Z2 = 5 - Setting_min_mq135
...
Read_mq9:
   ...
   Input_voltage = W / 0.2048
   Input_voltage = Input_voltage / 1000
   Z1 = Input_voltage -setting_min_mq9 : Z1 = Z1 * 100
   Z2 = 5 - Setting_min_mq9
   Input_percent_mq9 = Z1 / Z2
Return

'**********************************
Display_lcd:
   Locate 1 , 1 : Lcd "CH4"
   Locate 2 , 1 : Lcd Input_percent_mq4 ; "%   "

   Locate 1 , 6 : Lcd "CO2"
   Locate 2 , 6 : Lcd Input_percent_mq135 ; "%   "

   Locate 1 , 11 : Lcd "CO"
   Locate 2 , 11 : Lcd Input_percent_mq9 ; "%   "
...
Alarm_on_off:
      ...
      If Input_percent_mq4 > Setpoint_max Or Input_percent_mq135 > Setpoint_max Or Input_percent_mq9 > Setpoint_max Then
         State_alarm_on = 1
      Elseif Input_percent_mq4 <= Setpoint_min And Input_percent_mq135 <= Setpoint_min And Input_percent_mq9 <= Setpoint_min Then
         State_alarm_on = 0
      End If
...
Eeprom_load:
   ...
   Setting_min_mq4 = Setting_min_mq4_eeprom
   Setting_min_mq135 = Setting_min_mq135_eeprom
   Setting_min_mq9 = Setting_min_mq9_eeprom
Return
