...
Config Portc.7 = Input : Portc.7 = 1 : Set_key Alias Pinc.7
...
Config Portc.6 = Output : Buzzer Alias Portc.6 : Reset Buzzer

Config Portc.1 = Input : Smt160_pin Alias Pinc.1
...
Function Get_touch() As Byte
   ...
   If X_touch > 90 And X_touch < 145 Then
      If Y_touch > 295 And Y_touch < 405 Then Key = 1
      If Y_touch > 425 And Y_touch < 540 Then Key = 4
      If Y_touch > 560 And Y_touch < 670 Then Key = 7
      If Y_touch > 690 And Y_touch < 780 Then Key = 10
   Elseif X_touch > 175 And X_touch < 218 Then
      If Y_touch > 295 And Y_touch < 405 Then Key = 2
      If Y_touch > 425 And Y_touch < 540 Then Key = 5
      If Y_touch > 560 And Y_touch < 670 Then Key = 8
      If Y_touch > 690 And Y_touch < 780 Then Key = 0
   Elseif X_touch > 248 And X_touch < 300 Then
      If Y_touch > 295 And Y_touch < 405 Then Key = 3
      If Y_touch > 425 And Y_touch < 540 Then Key = 6
      If Y_touch > 560 And Y_touch < 670 Then Key = 9
      If Y_touch > 690 And Y_touch < 780 Then Key = 12
   Elseif X_touch > 330 And X_touch < 380 Then
      If Y_touch > 295 And Y_touch < 405 Then Key = 13
      If Y_touch > 425 And Y_touch < 540 Then Key = 14
      If Y_touch > 560 And Y_touch < 670 Then Key = 15
      If Y_touch > 690 And Y_touch < 780 Then Key = 16
    Elseif X_touch > 800 And X_touch < 859 Then
      If Y_touch > 150 And Y_touch < 270 Then Key = 17
    Elseif X_touch > 75 And X_touch < 380 Then
      If Y_touch > 150 And Y_touch < 275 Then Key = 18
   Else
      Key = Max_key
   End If
Get_touch = Key
