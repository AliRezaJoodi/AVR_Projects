...
Gosub Display_lcd
Locate 2 , 1 : Lcd Space(16) : Locate 2 , 1 : Lcd "Enter Card"
Gosub Sound_ok
...
Do
   ...
   If Telcard_key = 1 And Status_telcard_key2 = 0 Then
      ...
      Serialnumber = 0 : Gosub Display_lcd
      Locate 2 , 1 : Lcd Space(16) : Locate 2 , 1 : Lcd "Enter Card"
...
Open_the_door:
   ...
   For K = 0 To Capacity Step 4
      ...
      If Z1(1) = D(5) And Z1(2) = D(6) And Z1(3) = D(7) And Z1(4) = D(8) Then
         ...
         Locate 2 , 1 : Lcd Space(16) : Locate 2 , 1 : Lcd "Valid Account"
         Gosub Sound_ok
         Gosub Activate_relay
         'Reset Led_green : Reset Led_red
         Goto End_open_the_door
      End If
   Next K
   Locate 2 , 1 : Lcd Space(16) : Locate 2 , 1 : Lcd "Invalid Account"
   Reset Led_green : Set Led_red
   'Waitms 200 : Reset Led_green : Reset Led_red
   Gosub Sound_error
End_open_the_door:
...
Unregister_card:
   ...
   If Z1(1) <> &HFF Then
      ...
      If Z1(1) = D(5) And Z1(2) = D(6) And Z1(3) = D(7) And Z1(4) = D(8) Then
         ...
         'Set Led_red
         Locate 2 , 1 : Lcd Space(16) : Locate 2 , 1 : Lcd "Delete Account"
         Reset Led_green : Set Led_red
         Gosub Sound_ok
         'Waitms 200 : Reset Led_green : Reset Led_red
         Goto End_unregister_card
...
Register_card:
   ...
   For K = 0 To Capacity Step 4
      ...
      Incr I : Readeeprom Z1(4) , I                         ': Waitms 10
      If Z1(1) = D(5) And Z1(2) = D(6) And Z1(3) = D(7) And Z1(4) = D(8) Then
         Locate 2 , 1 : Lcd Space(16) : Locate 2 , 1 : Lcd "Add Account"
         'Set Led_green
         Set Led_green : Reset Led_red
         Gosub Sound_ok : Waitms 200 : Gosub Sound_ok
         Set Led_green : Reset Led_red
   ...
   Next K
   If K > Capacity Then
      Locate 2 , 1 : Lcd Space(16) : Locate 2 , 1 : Lcd "Memory is full"
      Set Led_red
...
Display_lcd:
   ...
   If Serialnumber <> 0 Then
      ...
      Locate 1 , 1 : Lcd "SN:" ; "xxxx" ; Serialnumber
   Else
      'Serialnumber = 0 : Sn_string = ""
      Locate 1 , 1 : Lcd "SN:" ; "___________"
   End If
...
'***********************************************
Unregister_all_card:
   Locate 2 , 1 : Lcd Space(16) : Locate 2 , 1 : Lcd "Please wait ..."
   'Set Led_red
   Reset Led_green : Set Led_red
   'Gosub Sound_ok
   'Gosub Sound_error
   ...
   Next K
   Locate 2 , 1 : Lcd Space(16) : Locate 2 , 1 : Lcd "Memory Erasure" : Waitms 500
   Reset Led_green : Reset Led_red
   Gosub Sound_ok
Return
