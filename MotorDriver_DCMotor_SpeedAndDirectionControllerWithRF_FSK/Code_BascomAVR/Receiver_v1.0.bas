...
Receiver_data:
   ...
   Select Case Z
      ...
      Case 13:
         ...
         If Address = "123" Then
               Command = Mid(s , 4 , 1)
               'If Command = "1" Then Gosub Right_motor
               Select Case Command
                  Case "1" : Gosub Right_motor
                  Case "2" : Gosub Left_motor
                  Case "3" : Gosub Up_motor
                  Case "4" : Gosub Down_motor
                  Case "5" : Gosub Stop_motor
               End Select
         End If
         S = ""
         Enable Urxc
